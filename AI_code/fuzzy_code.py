...
class Fuzzy:
    ...
    def create_fuzzy(self):
        ...
        self.danger = ctrl.ControlSystemSimulation(danger_ctrl)

    def compute(self, age, cigarettes, excercise, eating_unhealthy, anxiety):
        # # Pass inputs to the ControlSystem using Antecedent labels with Pythonic API
        # # Note: if you like passing many inputs all at once, use .inputs(dict_of_data)
        self.danger.input["age"] = age
        self.danger.input["Cigarettes"] = cigarettes
        self.danger.input["Exercise"] = excercise
        self.danger.input["Anxiety"] = anxiety
        self.danger.input["Eating unhealthy"] = eating_unhealthy
        # # Crunch the numbers
        self.danger.compute()
        return self.danger.output["Danger_status"]
